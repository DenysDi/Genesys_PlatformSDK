...
public class CHAT_FlexChatClient {
    private static FlexChatProtocol flexChat;
    private static final String queue = "MM8.0:MultimediaSDK_Process";

    private static final Map<String, ClientContext> clientMap = new HashMap<String, ClientContext>();
